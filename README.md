...
<div class="box21">
        <div class="row">
            <div class="col-lg-3"><img class="g11" src="assets/Polar_bear_travel_WW266640.jpg" alt="error"></div>
            <div class="col-lg-3"><img class="g21" src="assets/Foxes.jpg" alt="error"></div>
            <div class="col-lg-6"><img class="g31" src="assets/mountain-valley.jpg" alt="error"></div>
          </div>
        </div>